  ...
  return (
    <section className="about">
      ...
      <div className="about__floating-elements">
        <div className="about__floating-element about__floating-element--1"></div>
        <div className="about__floating-element about__floating-element--2"></div>
      </div>
      ...
      <div className={`about__container ${isVisible ? 'about__container--visible' : ''}`}>
        <div className="about__profile">
          ...
          <div className="about__location">
            <div className="about__location-item">
          ...
          <div className="about__social">
            ...
            <a href="#" className="about__social-link" aria-label="Dribbble">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="about__content">
          <div className="about__intro">
            ...
            <div className="about__eyebrow-line"></div>
          </div>
